...
Algo que senti falta é um módulo parseStringAsArray no backend para transformar a string techs. Na semana OmniStack 10 aprendi que não era possível enviar um array dessa forma pelo JSON no body. Não sei se algo mudou desde então ou me enganei? Conta pra mim no twitter [@tigo](https://twitter.com/tigo)
